...
with open("experiments/exp2_regpath.pkl", "rb") as f:
...
plt.tight_layout()
plt.savefig("experiments/exp2_regpath.png", dpi=150, bbox_inches="tight")
print("Saved: experiments/exp2_regpath.png")
plt.show()