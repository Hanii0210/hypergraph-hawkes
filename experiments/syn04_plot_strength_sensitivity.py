...
with open("experiments/results/synthetic/syn04_strength_sensitivity.pkl", "rb") as f:
...
plt.tight_layout()
plt.savefig("figures/synthetic/syn04_strength_sensitivity.png", dpi=150, bbox_inches="tight")
print("Saved: figures/synthetic/syn04_strength_sensitivity.png")
plt.show()