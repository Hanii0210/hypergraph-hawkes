"""
Experiment 12 — plot. Reads experiments/results/synthetic/suppD_rank_sweep.pkl and renders the
...
with open("experiments/results/synthetic/suppD_rank_sweep.pkl", "rb") as f:
