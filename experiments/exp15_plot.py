...
with open("experiments/exp15_interaction_baseline.pkl", "rb") as f:
    d = pickle.load(f)
...
plt.savefig("experiments/exp15_interaction_baseline.png", dpi=150, bbox_inches="tight")
print("Saved: experiments/exp15_interaction_baseline.png")