...
import pickle
with open("experiments/results/synthetic/syn06_trigger_window_sensitivity.pkl", "wb") as f:
    pickle.dump(results, f)
print("\nSaved: experiments/results/synthetic/syn06_trigger_window_sensitivity.pkl")