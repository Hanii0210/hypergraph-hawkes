...
Example:
    python experiments/real02_pvc3.py --raw-root data/raw --top-m-list 1,2,3 --n-iter 20
"""
...
def main():
    ...
    parser.add_argument("--out-prefix", default="experiments/results/realdata/real02_pvc3_area17")
