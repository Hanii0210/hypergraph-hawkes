...
with open("experiments/exp8_delta_sensitivity.pkl", "rb") as f:
...
plt.tight_layout()
plt.savefig("experiments/exp8_delta_sensitivity.png", dpi=150,
            bbox_inches="tight")
print("Saved: experiments/exp8_delta_sensitivity.png")
plt.show()