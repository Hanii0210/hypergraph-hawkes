...
trajectories  = np.load("experiments/exp3_trajectories.npy")
final_logliks = np.load("experiments/exp3_final_logliks.npy")
...
plt.tight_layout()
plt.savefig("experiments/exp3_convergence.png", dpi=150, bbox_inches="tight")
print("Saved: experiments/exp3_convergence.png")
plt.show()