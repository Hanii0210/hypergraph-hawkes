...
with open("experiments/exp7_likelihood_gap.pkl", "rb") as f:
...
plt.savefig("experiments/exp7_likelihood_gap.png", dpi=150,
            bbox_inches="tight")
print("Saved: experiments/exp7_likelihood_gap.png")
plt.show()