...
with open("experiments/exp1b_recovery_robustness.pkl", "rb") as f:
    data = pickle.load(f)
...
plt.tight_layout()
plt.savefig("experiments/exp1b_recovery_robustness.png", dpi=150,
            bbox_inches="tight")
print("Saved: experiments/exp1b_recovery_robustness.png")
plt.show()