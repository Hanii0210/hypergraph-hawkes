...
from experiments.exp13_selective_inference import (
...
def main(nseed, T, mode):
    ...
    if mode == "pairwise":
        ...
        with open("experiments/exp13_calibration.pkl", "wb") as f:
        ...
        print("Saved: experiments/exp13_calibration.pkl")
    else:
        results = dict(mode=mode, nseed=nseed, T=T, alpha=ALPHA, cands=CANDS,
                       p_split=ps_arr, picks=picks,
                       fpr_split=fpr_split, runtime_s=runtime)
        with open("experiments/exp13_control.pkl", "wb") as f:
            pickle.dump(results, f)
        ...
        print("Saved: experiments/exp13_control.pkl")
