...
with open("experiments/results/synthetic/suppE_calibration.pkl", "rb") as f:
    cal = pickle.load(f)
with open("experiments/results/synthetic/suppE_control.pkl", "rb") as f:
    ctrl = pickle.load(f)
...
plt.savefig("figures/synthetic/suppE_calibration.png", dpi=150, bbox_inches="tight")
print("Saved: figures/synthetic/suppE_calibration.png")