...
def main():
    ...
    with open("experiments/results/synthetic/syn09_identification_diagnostic.pkl", "wb") as f:
        pickle.dump({"rows": rows, "true_edge": TRUE_EDGE, "threshold": THRESHOLD,
                     "T": T, "seeds": SEEDS, "alpha_grid": ALPHA_GRID}, f)
    print("\nSaved: experiments/results/synthetic/syn09_identification_diagnostic.pkl")
