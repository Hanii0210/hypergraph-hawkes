...
with open("experiments/exp14_identification_diagnostic.pkl", "rb") as f:
    d = pickle.load(f)
...
plt.savefig("experiments/exp14_identification_diagnostic.png", dpi=150, bbox_inches="tight")
print("Saved: experiments/exp14_identification_diagnostic.png")